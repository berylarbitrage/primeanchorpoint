...
(function () {
  ...
  window.sms = {
    ...
    enableWirelessOverUsb: async () => ({ ok: true, message: 'ok', suggestedAddress: '192.168.1.42:5555' }),
    discoverWireless: async () => ({ ok: true, message: '找到并连上了 192.168.1.42:41235。', address: '192.168.1.42:41235' }),
